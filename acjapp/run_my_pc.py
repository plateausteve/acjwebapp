...
work_path = Path.home() / 'Dropbox' / 'djangodev3-1' / 'acjapp'  # or whatever...
...
pcf = PairedCompFrame(attributes=['Value'],
                       objects=['Scripts'], # may be taken from input data
                       objects_alias=['A'],  # to hide real object names in displays
                       forced_choice=False,
                       difference_grades=['Greater'],
                       test_factors={'Visual': ['visual']}
                       )
...
ds = PairedCompDataSet.load(pcf, data_path,
                            ...
                            pair=('D', 'E'),  # columns with labels of presented object pair
                            difference='J',  # column with difference_grade label
                            choice='I',  # column with selected object
                            no_choice=['None', ''],  # labels indicating no response, or no preference
                            Visual='K'  # column with category of test-factor Sound
                            )
